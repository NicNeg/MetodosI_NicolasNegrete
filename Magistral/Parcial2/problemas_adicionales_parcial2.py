...
#Raíces de polinomios_punto_5

'''
raices_p5 = GetAllRootsGLag(10)
print(raices_p5)
...
Iexactap6 = np.pi*(Rp6-(np.sqrt((Rp6**2)-(a**2))))
...
'''
Itp6 = ITp6(xp6, hp6)
errorT = np.abs(1-Itp6/Iexactap6) * 100
...
'''
ISp6 = ISp6(xp6, hp6)
errorS = np.abs(1-ISp6/Iexactap6) * 100
...
#Por las mismas razones que no puedo hallar raíces con n grandes, tampoco puedo hallar el valor de la integral igual a 1/NoV debido al numero extenso de raíces que necesito para acercame.
'''